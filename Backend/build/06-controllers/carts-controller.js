...
router.get('/cart-by-user/:userId/', verify_logged_in_1.default, function (request, response, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, carts_logic_1.default.getCartByUser(userId, false)];
            case 1:
                cart = _a.sent();
                response.json(cart);
                return [3 /*break*/, 3];
