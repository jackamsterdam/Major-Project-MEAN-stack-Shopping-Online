        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, carts_logic_1.default.closeCart(order.cartId.toString())
                        // add an order
                    ];
                case 1:
                    _a.sent();
...
function getAllOrders() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, order_model_1.OrderModel.find().populate('cart').populate('user').exec()];
        });
    });
}
//Count orders
function countOrders() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, order_model_1.OrderModel.find().count().exec()];
        });
    });
}
exports.default = {
