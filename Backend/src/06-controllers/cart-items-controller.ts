...
router.post('/items/:userId', async (request: Request, response: Response, next: NextFunction) => {
...
router.delete('/items/:_id/:cartId', async (request: Request, response: Response, next: NextFunction) => {
    try {
...
router.delete('/items/:cartId', async (request: Request, response: Response, next: NextFunction) => {
    try {
